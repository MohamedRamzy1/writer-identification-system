...
class LPQ:
    ...
    An implementation of LPQ texture descriptor that uses STFT
    on a rectangular window_size * window_size neighborhood,
    ...
    def __init__(self, window_size):
        # check if the window size < 3 set it to be 3
    ...
    def __calculate_LPQ(self, img):
        ...
        # (np.real and np.imaginary parts for each frequency).
        freqResp = np.dstack([
            filterResp1.real, filterResp1.imag, filterResp2.real,
            filterResp2.imag, filterResp3.real, filterResp3.imag,
    ...
    def fit(self, lines):
        ...
        for line in lines:
            ...
            # and save the result in lpq_features
